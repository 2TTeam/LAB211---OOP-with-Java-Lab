...
public class Utility { 
    ...
    public static final String ACCOUNT_PATTERN = "^[0-9]{10}$";
    public static final String ACCEPTED_CHACRACTERS_PATTERN = "[a-zA-Z0-9]";
    public static final String CONTAIN_DIGIT_PATTERN = "[0-9]+";
    public static final String CONTAIN_NON_UPPERCASE = "[a-z]+";
    public static final String CONTAIN_UPPERCASE = "[A-Z]+";
    ...
    public static double GetFloat(String msg, float min,float max){
        float i;
        Scanner sc = new Scanner(System.in);
        do{
            System.out.print(msg);
    ...
    public static String GetStringByRegex(String msg,String Patt, String wrongMsg){
        String s;
        Scanner sc = new Scanner(System.in);
        do{
            System.out.println(msg);
